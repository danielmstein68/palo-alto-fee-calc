...
#Fee rates from City of Palo Alto FY27 Impact Fee Information Sheet (as of August 17, 2026)
...
#SF: parks 18.75 + comm ctr 1.44 + libraries 0.86 = 21.05/sq ft; public safety 1383 + gen gov 1743 = 3126/unit
#MF: parks 44.47 + comm ctr 3.43 + libraries 2.04 = 49.94/sq ft; public safety 1107 + gen gov 1394 = 2501/unit
def calc_community (project_sq_ft, project_num_units, res_type):
    if res_type=="Single Family":
        return (project_sq_ft * 21.05) + (project_num_units * 3126)
    elif res_type=="Multi-Family":
        return (project_sq_ft * 49.94) + (project_num_units * 2501)
...
def calc_housing (project_sq_ft, project_type):
    ...
    if project_type=="Single family detached":
        z=100.18
    elif project_type=="Single family attached":
        z=66.78
    elif project_type=="Condominiums":
        z=66.38
...
def calc_traffic(place,project_num_units, parking, trips):
    ...
    if place=="Downtown assessment district":
        location_specific=parking*136354
    elif place=="Charleston or Arastradero":
        location_specific=project_num_units*1743
    citywide=10099*trips
...
def calc_park (res_type, project_num_units):
    if res_type=="Single Family":
        return 81829*project_num_units
    else:
        return 56402*project_num_units
